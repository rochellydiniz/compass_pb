...
# Avaliar o que ambas as listas têm em comum (sem repetições)
interseccao = list (set(a) & set(b))

# Imprimir a lista de valores da intersecção na saída padrão
print(interseccao)